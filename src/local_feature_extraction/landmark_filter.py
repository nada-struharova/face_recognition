...
def filter_landmarks(face_data):
    ...
    distances = {
        ...
        # TODO: Add more distances to check
    }

    # OUTLIER CHECK
    # TODO: statistics from non-occluded faces --> compute these from large dataset
...
def detect_occlusion(face_data):
    ...
    expected_eye_to_eye = get_distance(right_eye, left_eye) # TODO: compute w.r.t. bbox
    expected_eye_to_nose_right = 0.35 * bbox_width  # w.r.t. bbox
    expected_eye_to_nose_left = 0.35 * bbox_width  # w.r.t. bbox
